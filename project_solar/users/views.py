...
def user_posts(username):
    ...
    solar_posts = SolarPost.query.filter_by(author=user).order_by(SolarPost.date.desc()).paginate(page=page,per_page=5)
    return render_template('user_solar_posts.html',solar_posts=solar_posts,user=user)
